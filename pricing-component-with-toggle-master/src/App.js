...
function App() {
  ...
  return (
    <div className='app'>
      ...
      <h2>Our Pricing</h2>
      <Toggle isMonthlyPrice={isMonthlyPrice} setIsMonthlyPrice={setIsMonthlyPrice} />
      <div className='cards'>
        <SideCard isMonthlyPrice={isMonthlyPrice} type="Basic" price="199.99" monthlyPrice="19.99" users="2" storage="500 GB" data="3" />
        <MainCard isMonthlyPrice={isMonthlyPrice} />
        <SideCard isMonthlyPrice={isMonthlyPrice} type="Master" price="399.99" monthlyPrice="39.99" users="10" storage="2 TB" data="20"/>
      </div>
    </div>
  )
}
